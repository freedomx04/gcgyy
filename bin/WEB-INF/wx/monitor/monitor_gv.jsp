...
<body class="wx-monitor" style="background-color: #f8f8f8; width: 100%;">
	...
	<script class="template SaleTarget" type="text/x-jquery-tmpl">
	<thead>
		<tr>
			<th>月份</th>
			<th>本月止销售收入(元)</th>
		...
		function getData(year, month) {
			...
			$.ajax({
				...
				success: function(data) {
					if (subItem == "7") {
						$page.find(".nationalTax-table").show();
						$page.find(".nationalTax-table").find(".table-title").text("销售收入数据详情");
						$page.find(".nationalTax-sale-table").html(
							$(".template.SaleTarget").doT({
